    ...
    return (
        <>
            ...
            <div className="mx-auto p-6">
                <section className=" p-6 rounded-lg flex flex-col md:flex-row items-center">
                    <div className=" flex-1 w-full md:w-1/2 ">
                        <h1 className="text-3xl font-bold">Affordable Hip replacement Surgery</h1>
            ...
            <div>
                ...
                <p className="text-gray-600 mt-2">Before considering hip replacement surgery, it's essential to recognize the signs and symptoms that may indicate a need for the procedure 
                </p>
