...
const UnderstandCauses = () => {
  ...
  <div className="container mx-auto px-4 py-8">
   ...
   <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-8 text-center">
    <div>
     <img alt="Illustration of aging process" className="mx-auto mb-4" height="64" src="/images/u-1.png" width="64"/>
    ...
    <div>
     <img alt="Illustration of UV radiation" className="mx-auto mb-4" height="64" src="/images/u-2.png" width="64"/>
     <h2 className="text-lg font-bold">
    ...
    <div>
     <img alt="Illustration of uveitis" className="mx-auto mb-4" height="64" src="/images/u-3.png" width="64"/>
     <h2 className="text-lg font-bold">
      Uveitis
     </h2>
     <p>
    ...
    <div>
     <img alt="Illustration of smoking" className="mx-auto mb-4" height="64" src="/images/u-4.png" width="64"/>
     <h2 className="text-lg font-bold">
      Smoking
     </h2>
     <p>
    ...
    <div>
     <img alt="Illustration of diabetes" className="mx-auto mb-4" height="64" src="/images/u-5.png" width="64"/>
     <h2 className="text-lg font-bold">
      Diabetes
     </h2>
     <p>
    ...
    <div>
     <img alt="Illustration of eye injuries" className="mx-auto mb-4" height="64" src="/images/u-6.png" width="64"/>
     <h2 className="text-lg font-bold">
      Eye Injuries
     </h2>
     <p>
...
export default UnderstandCauses;